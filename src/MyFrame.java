...
public class MyFrame extends JFrame implements KeyListener { // My custom JFrame
    ...
    MyFrame() { //Constructs the JFrame
        ...
        try {
            cubeIcon = new ImageIcon(read(Objects.requireNonNull(this.getClass().getResourceAsStream("/CubeIcon.png"))));
            smallCubeIcon = new ImageIcon(read(Objects.requireNonNull(this.getClass().getResourceAsStream("/SmallerCubeIcon.png"))));
        } catch (IOException e) {
